...
class DefaultAxisValueFormatterTest {
	...
	fun getFormattedValue_positiveDigits() {
		...
		assertThat(formatter.getFormattedValue(-1234.567891f, null)).isEqualTo("-1,234.56787")
		assertThat(formatter.getFormattedValue(-123.45f, null)).isEqualTo("-123.45000")
		assertThat(formatter.getFormattedValue(0f, null)).isEqualTo("0.00000")
		assertThat(formatter.getFormattedValue(123.45f, null)).isEqualTo("123.45000")
		assertThat(formatter.getFormattedValue(1234.567891f, null)).isEqualTo("1,234.56787")
	}
